...
const handleRateChange = (e) => {
  ...
  if (value === '' || (Number(value) <= 12 && Number(value) >= 0)) {
    ...
    setErrors((prev) => ({ ...prev, interestRate: 'Rate cannot exceed 50%' }));
  }
};
...
const handleYearChange = (e) => {
  ...
  if (value === '' || (Number(value) <= 30 && Number(value) >= 0)) {
    ...
    setErrors((prev) => ({ ...prev, loanPeriod: 'Loan tenure cannot exceed 30 years' }));
  }
};
        ...
        <div className="grid lg:grid-cols-[420px_1fr] xl:grid-cols-[530px_1fr] 2xl:grid-cols-[640px_1fr] grid-cols-1">
          ...
          <div className="px-1 py-6">
            ...
            <p className="text-md text-gray-600 mt-2">
              ...
              Enter the loan amount, interest rate, and tenure to get instant results.
            </p>
          </div>
                ...
                <div className="bg-IntColor rounded-xl p-6 shadow flex-grow">
                  <div className="grid grid-cols-1 gap-y-5">
                    ...
                    <div className="relative group">
                      <label htmlFor="loanAmount" className="block text-sm font-semibold text-gray-800 px-0.5 py-3">
                        Loan Amount (₹)
                      </label>
                      <div className={`flex items-center w-full max-w-xl border rounded-xl px-2 py-1
                          ${errors.loanAmount ?"border-red-500 shadow":"border-gray-200 focus-within:border-primary focus-within:shadow-primary focus-within:shadow"
                      }`}>
                    ...
                    <div className="relative group">
                      ...
                      <div className={`flex items-center w-full max-w-xl border rounded-xl px-2 py-1
                          ${errors.interestRate?"border-red-400 shadow":"border-gray-200 focus-within:border-primary focus-within:shadow-primary focus-within:shadow"
                      }`}>
                        <input
                          id="interestRate"
                          type="number"
                    ...
                    <div className="relative group">
                      ...
                      <div className={`flex items-center w-full max-w-xl border rounded-xl px-2 py-1
                          ${errors.loanPeriod?"border-red-600 shadow":"border-gray-200 focus-within:border-primary focus-within:shadow-primary focus-within:shadow"
                      }`}>
                        <input
                          id="loanPeriod"
                          type="number"
                ...
                <div className="bg-primary rounded-xl p-6 shadow flex flex-col justify-between h-full">
                  ...
                  {(frequency === "monthly" || frequency === "both") && (
                    <div className="bg-IntColor p-6 rounded-lg shadow-inner mb-4">
                      <h3 className="text-primary mb-3 text-2xl font-extrabold text-center">Monthly EMI</h3>
                      <div className="flex flex-col justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                        ...
                        <span className="text-green-700 font-semibold text-lg">₹{monthlyResult.emi.toLocaleString('en-IN')}</span>
                      </div>
                      <div className="flex flex-col justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                        <span className="text-gray-700 font-medium">Total Interest:</span>
                        <span className="text-green-700 font-semibold text-lg">₹{monthlyResult.interest.toLocaleString('en-IN')}</span>
                      </div>
                      <div className="flex flex-col justify-between items-center py-2">
                        <span className="text-gray-700 font-medium">Total Payment:</span>
                        <span className="text-green-700 font-semibold text-lg">₹{monthlyResult.total.toLocaleString('en-IN')}</span>
                      </div>
                    </div>
                  )}
                  ...
                  {(frequency === "yearly" || frequency === "both") && (
                    <div className="bg-IntColor p-6 rounded-lg shadow-inner">
                      <h3 className="text-primary mb-3 text-2xl font-extrabold text-center">Yearly EMI</h3>
                      <div className="flex flex-col justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                        <span className="text-gray-700 font-medium">EMI:</span>
                        <span className="text-green-700 font-semibold text-lg">₹{yearlyResult.emi.toLocaleString('en-IN')}</span>
                      </div>
                      <div className="flex flex-col justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                        <span className="text-gray-700 font-medium">Total Interest:</span>
                        <span className="text-green-700 font-semibold text-lg">₹{yearlyResult.interest.toLocaleString('en-IN')}</span>
                      </div>
                      <div className="flex flex-col justify-between items-center py-2">
                        <span className="text-gray-700 font-medium">Total Payment:</span>
                        <span className="text-green-700 font-semibold text-lg">₹{yearlyResult.total.toLocaleString('en-IN')}</span>
                      </div>
                    </div>
                  )}
